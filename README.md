...
For detailed usage examples, please refer to the in-sample tutorial notebook [`in_sample`](tutorial_in_sample.ipynb) and the out-of-sample tutorial notebook [`out-of-sample`](tutorial_out_of_sample.ipynb), which demonstrate the complete workflow, including data download and loading, model training and prediction, and quantitative evaluation.
